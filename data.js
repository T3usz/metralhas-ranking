...
const data_2025_10 = [
  {rank:1,  name:"Alison7",    rec:"1V • 0E • 0D",  rate:100, games:1},
  {rank:2,  name:"César",      rec:"2V • 0E • 0D",  rate:100, games:2},
  {rank:3,  name:"Guilherme",  rec:"1V • 0E • 0D",  rate:100, games:1},
  {rank:4,  name:"Rafael",     rec:"1V • 0E • 0D",  rate:100, games:1},
  {rank:5,  name:"Vt7",        rec:"22V • 6E • 4D", rate:69,  games:32},
  {rank:6,  name:"Edgar",      rec:"6V • 2E • 0D",  rate:75,  games:8},
  {rank:7,  name:"Dl7",        rec:"31V • 4E • 5D", rate:77,  games:40},
  {rank:8,  name:"Quirino",    rec:"11V • 2E • 3D", rate:69,  games:16},
  {rank:9,  name:"Neymar",     rec:"8V • 3E • 0D",  rate:73,  games:11},
  {rank:10, name:"Caio",       rec:"8V • 2E • 5D",  rate:53,  games:15},
  {rank:11, name:"Gbdazarea",  rec:"12V • 6E • 2D", rate:60,  games:20},
  {rank:12, name:"Gordin",     rec:"3V • 1E • 3D",  rate:43,  games:7},
  {rank:13, name:"Gustavo",    rec:"6V • 3E • 2D",  rate:55,  games:11},
  {rank:14, name:"Leoni",      rec:"4V • 2E • 0D",  rate:67,  games:6},
  {rank:15, name:"Pulgar",     rec:"19V • 8E • 2D", rate:66,  games:29},
  {rank:16, name:"Everton",    rec:"25V • 11E • 7D",rate:58,  games:43},
  {rank:17, name:"Italodugrau",rec:"1V • 1E • 1D",  rate:33,  games:3},
  {rank:18, name:"Kg",         rec:"5V • 4E • 1D",  rate:50,  games:10},
  {rank:19, name:"César",      rec:"3V • 2E • 0D",  rate:60,  games:5},
  {rank:20, name:"Carlos",     rec:"1V • 1E • 0D",  rate:50,  games:2},
  {rank:21, name:"Lucas",      rec:"1V • 1E • 0D",  rate:50,  games:2},
  {rank:22, name:"Mayra",      rec:"3V • 2E • 1D",  rate:50,  games:6},
  {rank:23, name:"Rickinho",   rec:"6V • 3E • 5D",  rate:43,  games:14},
  {rank:24, name:"Iury",       rec:"4V • 2E • 1D",  rate:57,  games:7},
  {rank:25, name:"Ednaldo",    rec:"12V • 3E • 0D", rate:80,  games:15},
  {rank:26, name:"Albano",     rec:"2V • 1E • 0D",  rate:67,  games:3},
  {rank:27, name:"Sm7",        rec:"2V • 1E • 0D",  rate:67,  games:3},
  {rank:28, name:"Kl",         rec:"11V • 7E • 2D", rate:55,  games:20},
  {rank:29, name:"Malvadeza",  rec:"3V • 4E • 4D",  rate:27,  games:11},
  {rank:30, name:"Vitor",      rec:"3V • 4E • 0D",  rate:43,  games:7},
  {rank:31, name:"Sawã",       rec:"0V • 2E • 0D",  rate:0,   games:2},
  {rank:32, name:"Davx",       rec:"0V • 2E • 1D",  rate:0,   games:3},
  {rank:33, name:"Murcia",     rec:"0V • 1E • 0D",  rate:0,   games:1},
  {rank:34, name:"Lc7",        rec:"2V • 3E • 0D",  rate:40,  games:5},
  {rank:35, name:"Rn",         rec:"1V • 0E • 1D",  rate:50,  games:2},
  {rank:36, name:"Lima",       rec:"1V • 2E • 0D",  rate:33,  games:3},
  {rank:37, name:"Bk3",        rec:"1V • 3E • 1D",  rate:20,  games:5},
];
